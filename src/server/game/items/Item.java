...
public class Item {
    ...
    private static String[] fullbody = {"top","shirt","platebody","Ahrims robetop","Karils leathertop","brassard","Robe top","robe","Robe","robetop","platebody (t)","platebody (g)","chestplate","torso", "hauberk", "Dragon chainbody", "robe (t)"};
