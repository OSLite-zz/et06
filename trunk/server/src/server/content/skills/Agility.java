...
//shortcuts
	public void shortCut(final Client c) {
			if (System.currentTimeMillis() - c.foodDelay < 2000) {
				return;
			}
				c.stopMovement();
				...
				c.updateRequired = true;
				c.appearanceUpdateRequired = true;
				c.getAgil().gnomeLog(c, "Log", 1, +6, 0, 2196, 3237, 8 * Config.AGILITY_EXPERIENCE);
				c.foodDelay = System.currentTimeMillis();
				CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
					@Override
					public void execute(CycleEventContainer container) {
		...
		public void shortCutb(final Client c) {
			if (System.currentTimeMillis() - c.foodDelay < 2000) {
				return;
			}
				c.stopMovement();
				...
				c.updateRequired = true;
				c.appearanceUpdateRequired = true;
				c.getAgil().gnomeLog(c, "Log", 1, -6, 0, 2202, 3237, 8 * Config.AGILITY_EXPERIENCE);
				c.foodDelay = System.currentTimeMillis();
				CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
					@Override
					public void execute(CycleEventContainer container) {
	...
	public void shortCutTwo(final Client c) {
			if (System.currentTimeMillis() - c.foodDelay < 2000) {
				return;
			}
				c.stopMovement();
				...
				c.updateRequired = true;
				c.appearanceUpdateRequired = true;
				c.getAgil().gnomeLog(c, "Log", 1, +6, 0, 2258, 3250, 8 * Config.AGILITY_EXPERIENCE);
				c.foodDelay = System.currentTimeMillis();
				CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
					@Override
					public void execute(CycleEventContainer container) {
		...
		public void shortCutc(final Client c) {
			if (System.currentTimeMillis() - c.foodDelay < 2000) {
				return;
			}
				c.stopMovement();
				...
				c.updateRequired = true;
				c.appearanceUpdateRequired = true;
				c.getAgil().gnomeLog(c, "Log", 1, -6, 0, 2264, 3250, 8 * Config.AGILITY_EXPERIENCE);
				c.foodDelay = System.currentTimeMillis();
				CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
					@Override
					public void execute(CycleEventContainer container) {
	...
	public void shortCutThree(final Client c) {
			if (System.currentTimeMillis() - c.foodDelay < 2000) {
				return;
			}
				c.stopMovement();
				...
				c.updateRequired = true;
				c.appearanceUpdateRequired = true;
				c.getAgil().gnomeLog(c, "Log", 1, 0, -7, 2290, 3239, 8 * Config.AGILITY_EXPERIENCE);
				c.foodDelay = System.currentTimeMillis();
				CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
					@Override
					public void execute(CycleEventContainer container) {
		...
		public void shortCutd(final Client c) {
			if (System.currentTimeMillis() - c.foodDelay < 2000) {
				return;
			}
				c.stopMovement();
				...
				c.updateRequired = true;
				c.appearanceUpdateRequired = true;
				c.getAgil().gnomeLog(c, "Log", 1, 0, +7, 2290, 3232, 8 * Config.AGILITY_EXPERIENCE);
				c.foodDelay = System.currentTimeMillis();
				CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
					@Override
					public void execute(CycleEventContainer container) {
